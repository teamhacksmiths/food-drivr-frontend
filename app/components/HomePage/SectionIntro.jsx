...
const paragraphOne = "On a daily basis catering facilities, restaurants, grocery stores, as well as individuals produce more food than what is needed for them to meet their needs."
...
const SectionIntro = () => (
  <section className="intro">
    <header className="text-center text-white">
      ...
      <p className="intro__powered">{poweredByLineTwo}</p>
