...
const oops = 'oops,';
const message = `Because of all the amazing people dontaing food
  our servers appear to be having a problem.
  Please come back later or contact our support
...
const SomethingWentWrong = () => (
  <section className="something-went-wrong__section text-center text-white">
    <header className="uppercase">
      <WhiteTruckButton />
      <h1 className="something-went-wrong__header">
        {oops}
      </h1>
      <h2 className="something-went-wrong__subheader">
        {somethingGoneWrong}
      </h2>
    </header>
    ...
    <Link to="mailto: admin@fooddrivr.com">
      <button
        className="btn btn-rect--hover bg-white text-red"
      >
        Contact Support
      </button>
    </Link>
