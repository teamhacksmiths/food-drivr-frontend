...
import AddressListMenu from '../Reusable/AddressListMenu.jsx';
...
class UserProfile extends React.Component {
	...
	handleFormUpdate(name, e) {
		const formData = this.props.userData;
	...
	render() {
		...
		const buttonMarginStyle = { margin: 12 };
		return (
			<div className="user-profile-container">
				<div className="user-avatar-frame">
					<img role="presentation" className="user-avatar-image" src={userData.avatar ? userData.avatar : AvatarMissing} />
				</div>
