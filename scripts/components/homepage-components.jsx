        ...
        return (
            <div className='homepage-becomedriver'>
                ...
                <div className='becomedriver-content text-white'>
                    ...
                    <p>Are people who would rather see their extra food do some good instead of going to waste! We accept donations from business such as catering companies & facilites, restaurants and forcery stores, as well as donations from individuals.</p>
